...
public class GameOver implements Screen {
	...
	public GameOver(SpaceRocks game, AssetManager assets) {
		this.game = game;
		this.assets = assets;
	...
	private void drawGUI() {
		font.draw(batch, "Game Over", width / 2 - font.getSpaceWidth() * 5, height * 5 / 6 - font.getCapHeight());
		font.draw(batch, "Your score: ", width / 2 - font.getSpaceWidth() * 5.5f, height * 4 / 6 - font.getCapHeight());
		font.draw(batch, String.valueOf(game.finalScore), width / 2 - font.getSpaceWidth() * 1, height * 3 / 6 - font.getCapHeight());
		font.draw(batch, "Enter score", width / 2 - font.getSpaceWidth() * 6, height * 2 / 6 - font.getCapHeight());
	}
